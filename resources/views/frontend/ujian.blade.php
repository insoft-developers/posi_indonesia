                ...
                <div class="row" id="soal-container">
                    ...
                    <div class="col-md-10 col-sm-10 col-lg-10">
                        @php
                            ...
                            } elseif ($soal[$nomor]->orientation == 1) {
                        ...
                        <div class="soal-wrapper" style="{{ $style }}">
                            ...
                            @if ($soal[$nomor]->question_image != null)
                                <img src="{{ asset('storage/image_files/soal/' . $soal[$nomor]->question_image) }}"
                                    class="gambar-soal img-responsive">
                            @endif
                        ...
                        <div class="jawaban-wrapper">
                            ...
                            <div class="row">
                                    ...
                                    @if ($ada == 1 && $exist->jawaban_soal == 'a')
                                        <div onclick="selected(1)" id="jawaban-a" class="jawaban-item selected-jawaban">
                                            @if ($soal[$nomor]->option_image_a != null)
                                                <img src="{{ asset('storage/image_files/jawaban/' . $soal[$nomor]->option_image_a) }}"
                                                    class="img-responsive gambar-soal">
                                            @endif
                                            A.
                                            <?= $soal[$nomor]->option_a ?>
                                        </div>
                                    ...
                                    @if ($ada == 1 && $exist->jawaban_soal == 'b')
                                        <div onclick="selected(2)" id="jawaban-b" class="jawaban-item selected-jawaban">
                                            @if ($soal[$nomor]->option_image_b != null)
                                                <img src="{{ asset('storage/image_files/jawaban/' . $soal[$nomor]->option_image_b) }}"
                                                    class="img-responsive gambar-soal">
                                            @endif
                                            B.
                                            <?= $soal[$nomor]->option_b ?>
                                    ...
                                    @if ($ada == 1 && $exist->jawaban_soal == 'c')
                                        <div onclick="selected(3)" id="jawaban-c" class="jawaban-item selected-jawaban">
                                            @if ($soal[$nomor]->option_image_c != null)
                                                <img src="{{ asset('storage/image_files/jawaban/' . $soal[$nomor]->option_image_c) }}"
                                                    class="img-responsive gambar-soal">
                                            @endif
                                            C.
                                            <?= $soal[$nomor]->option_c ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    @if ($ada == 1 && $exist->jawaban_soal == 'd')
                                        <div onclick="selected(4)" id="jawaban-d" class="jawaban-item selected-jawaban">
                                            @if ($soal[$nomor]->option_image_d != null)
                                                <img src="{{ asset('storage/image_files/jawaban/' . $soal[$nomor]->option_image_d) }}"
                                                    class="img-responsive gambar-soal">
                                            @endif
                                            D.
                                            <?= $soal[$nomor]->option_d ?>
                                    ...
                                    @if ($ada == 1 && $exist->jawaban_soal == 'e')
                                        <div onclick="selected(5)" id="jawaban-e" class="jawaban-item selected-jawaban">
                                            @if ($soal[$nomor]->option_image_e != null)
                                                <img src="{{ asset('storage/image_files/jawaban/' . $soal[$nomor]->option_image_e) }}"
                                                    class="img-responsive gambar-soal">
                                            @endif
                                            E.
                                            <?= $soal[$nomor]->option_e ?>
                                    ...
                                    <div style="display: none;" onclick="lewati_soal()" id="jawaban-f"
                                        class="jawaban-item">LEWATI</div>
                        ...
                        <hr />
                        <button onclick="sebelumnya()" class="btn-sebelumnya-insoft"><i class="fa fa-arrow-left"></i>
                            Sebelumnya</button>

                        <button onclick="lewati_soal()" class="btn-selanjutnya-insoft">Selanjutnya <i
                                class="fa fa-arrow-right"></i></button>
                        <button onclick="simpan_jawaban()" class="btn-simpan-insoft"><i class="fa fa-save"></i> Simpan
                            Jawaban</button>

                        <button onclick="selesai_ujian()" class="btn-selesai-insoft"><i class="fa fa-check"></i>
                            Selesai</button>
