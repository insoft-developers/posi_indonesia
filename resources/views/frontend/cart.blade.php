                                ...
                                @foreach ($cart as $index => $c)
                                    ...
                                    <tr style="vertical-align: middle">
                                        ...
                                        @if ($c->type == 1)
                                            ...
                                            @php
                                                ...
                                                $session = \App\Models\ExamSession::where('userid', $c->user->id)
                                                    ...
                                                    ->first();
                                            @endphp
                                            <td width="35%"><strong><span
                                                        class="m-title">{{ strtoupper($c->product->product_name) }}</strong>
                                        ...
                                        @else
                                            ...
                                            <td width="35%"><span class="m-title">Pendaftaran
                                                    {{ $c->competition->title }}
                                                    ...
                                                    @endphp
                                                    <span
                                                        style="font-size: 13px; color:blue;">{{ $c->study->pelajaran->name }}
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="single-form">
                                            <input type="text" id="receiver_name" name="receiver_name"
                                                placeholder="Masukkan Nama Penerima" value="">
                                        ...
                                        <div class="single-form">
                                            <input type="text" id="receiver_phone" name="receiver_phone"
                                                placeholder="Masukkan No HP Penerima" value="">

                                            <x-input-error :messages="$errors->get('receiver_name')" class="mt-2" />
                                        </div>

                                        <div class="single-form">
                                            <textarea id="alamat" name="alamat" style="height: 120px" placeholder="Masukkan alamat lengkap penerima"
                                                value=""></textarea>
