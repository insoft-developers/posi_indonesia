    ...
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            ...
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Syarat & Ketentuan</li>
            </ul>
        </div>

        <div class="card basic-data-table">
            <div class="card-header">
                <h5 class="card-title mb-0">Syarat & Ketentuan</h5>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <form name="form-update" method="POST" action="{{ route('term.update') }}">
                        @csrf
                        
                        <div class="col-12">
                            <label class="form-label">Syarat Ketentuan</label>
                            <textarea id="term" name="term" class="form-control"><?= $data->term ?></textarea>
                        </div>
