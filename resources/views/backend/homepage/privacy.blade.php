    ...
    <div class="dashboard-main-body">
        ...
        <div class="card basic-data-table">
            <div class="card-header">
                <h5 class="card-title mb-0">Kebijakan Privasi</h5>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <form name="form-update" method="POST" action="{{ route('privacy.update') }}">
                        @csrf
                        
                        <div class="col-12">
                            <label class="form-label">Kebijakan Privasi</label>
                            <textarea id="privacy" name="privacy" class="form-control"><?= $data->privacy ?></textarea>
                        </div>
