@if ($view == 'testimony')
    <script>
        function tambah() {
            ...
            $(".modal-title").text('Tambah Testimony');
            reset_form();
        }
        ...
        $("#form-tambah").submit(function(e) {
            ...
            e.preventDefault();
            var id = $('#id').val();
            if (save_method == "add") url = "{{ url('/posiadmin/testimony') }}";
            else url = "{{ url('/posiadmin/testimony') . '/' }}" + id;
        ...
        function editData(id) {
            ...
            $.ajax({
                url: "{{ url('/posiadmin/testimony') }}" + "/" + id + "/edit",
                type: "GET",
                dataType: "JSON",
                success: function(data) {
                    $('#modal-tambah').modal("show");
        ...
        function deleteData(id) {
            ...
            if (pop === true) {
                $.ajax({
                    url: "{{ url('posiadmin/testimony') }}" + "/" + id,
                    type: "DELETE",
                    dataType: "JSON",
