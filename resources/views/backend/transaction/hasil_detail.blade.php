    ...
    <div class="dashboard-main-body">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            ...
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Daftar Hasil Ujian</li>
                <li>-</li>
                <li class="fw-medium">Daftar Jawaban</li>
            </ul>
        </div>
        
        <div class="card basic-data-table">
            <div class="card-header">
                <h5 class="card-title mb-0">{{ $session->user->name }} - {{ $session->competition->title }} - {{ $session->study->pelajaran->name }} - {{ $session->study->level->level_name }}</h5>
